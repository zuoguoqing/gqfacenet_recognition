...
cfg_detect_frontal_face = 'model/haarcascade_frontalface_alt.xml'
cfg_detect_profile_face = 'model/haarcascade_profileface.xml'
...
class detect_face_orientation:
    def __init__(self):
        self.detect_frontal_face = cv2.CascadeClassifier(cfg_detect_frontal_face)
        self.detect_profile_face = cv2.CascadeClassifier(cfg_detect_profile_face)
